...
public enum DomainExceptionCode {
    ...
    JWT_TOKEN_NOT_FOUND(JWT.code + 1, "JWT 토큰을 찾을 수 없습니다."),
    JWT_TOKEN_EXPIRED(JWT.code + 2, "JWT 토큰이 만료되었습니다."),
    JWT_TOKEN_CLAIM_NOT_FOUND(JWT.code + 3, "JWT 토큰의 클레임을 찾을 수 없습니다."),
    JWT_MAL_FORMED(JWT.code + 4, "잘못된 형식의 JWT 토큰입니다."),
    ...
    SORTING_NOT_FOUND(SORTING.code + 1, "정렬 조건을 찾을 수 없습니다."),
    ...
    ROLE_NAME_INVALID(ROLE.code + 5, "역할 이름이 올바르지 않습니다."),
